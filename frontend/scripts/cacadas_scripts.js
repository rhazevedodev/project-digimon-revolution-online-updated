document.addEventListener('DOMContentLoaded', function () {
    const apiURL = 'http://localhost:8080/api/telaCacadas/carregaTelaCacadas';
    const apiResgateCacadaURL = 'http://localhost:8080/api/cacada/resgatarRecompensa';
    const apiIniciarCacadaURL = 'http://localhost:8080/api/cacada/iniciarCacada';
    ...
    document.addEventListener('click', function (event) {
        ...
        if (event.target && event.target.id === 'button-resgatar-recompensa-cacada') {
            //const idDigimon = '3';
            resgatarRecompensa(localStorage.getItem('idDigimon'));
        }
